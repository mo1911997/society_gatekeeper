            ...
            Container(
              ...
              borderSide: BorderSide(color: Colors.black, width: 3),
                ...
                Visibility( 
                  ...
                  child: Text(newPasswordErrorText,style: TextStyle(color: Colors.red,fontSize: 14.0,fontFamily: 'Raleway',)),
                ),
                Container(
                  child: TextField(
                    cursorColor: Colors.black,
              ...
              borderSide: BorderSide(color: Colors.black, width: 3),
                ...
                Visibility( 
                  ...
                  child: Text(confirmPasswordErrorText,style: TextStyle(color: Colors.red,fontSize: 14.0,fontFamily: 'Raleway',)),
                ),
                Container(
                  child: RaisedButton(
                    child: Text(
                    ...
                    onPressed: () async {
                      ...
                      if(newPasswordController.text == confirmPasswordController.text) 
                      {
                        ...
                        changePasswordBloc.password.value = newPasswordController.text;
